...
public class TransferData extends AsyncTask<Void, String, Void> {
    ...
    protected void onProgressUpdate(String... values) {
        ...
        for (int i = 0; i < this.sendFilesAdapter.filesSendViewHolders.size(); i++) {
            if (this.sendFilesAdapter.filesSendViewHolders.get(i).fileModel.getFileName().equals(values[0])) {
                this.sendFilesAdapter.filesSendViewHolders
